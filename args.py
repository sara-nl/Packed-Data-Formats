...
def parse_args():
    parser = argparse.ArgumentParser(description="Arguments for packed data format benchmark")
    ...
    parser.add_argument("-pw", "--persistent-workers", type=int, default=0, choices=[0,1])
    ...
    # Device
    parser.add_argument("-dvc", "--device", type=str, default="cuda", choices=["cpu", "cuda"])
